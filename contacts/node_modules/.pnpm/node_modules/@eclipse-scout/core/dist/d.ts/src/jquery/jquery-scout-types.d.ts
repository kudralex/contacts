...
export type AppLinkBeanArgument = {
    ref: string;
    name: string;
} | string;
export type AppLinkFuncArgument<T> = JQuery.TypeEventHandler<T, undefined, T, T, 'click'> | {
    _onAppLinkAction: JQuery.TypeEventHandler<T, undefined, T, T, 'click'>;
};
export type JQueryMouseWheelEvent<TDelegateTarget = any, TData = any, TCurrentTarget = any, TTarget = any> = JQuery.TriggeredEvent<TDelegateTarget, TData, TCurrentTarget, TTarget> & {
    originalEvent: OldWheelEvent;
};
declare global {
    ...
    interface JQueryStatic {
         ...
         */
        debounce(fx: (...args: any[]) => void, options?: DebounceOptions | number): ((...args: any[]) => void) & {
            cancel(): boolean;
        };
        /**
    ...
    interface JQuery<TElement = HTMLElement> extends Array<TElement | JQuery> {
        ...
        animateAVCSD(attr: string, value: any, complete?: (elem: JQuery) => void, step?: (elem: JQuery) => void, duration?: number): this;
        /**
         ...
         */
        animateSVG(attr: string, endValue: number, duration: number, complete: (HTMLElement: any) => void, withoutTabIndex: boolean): this;
        /**
         ...
         */
        addClassForAnimation(className: string, options?: {
            classesToRemove?: boolean;
        }): this;
        /**
         ...
         */
        cssWidthAnimated(oldWidth: number, newWidth: number, options: JQuery.EffectsOptions<TElement>): any;
        /**
         * Animates from old to new height. The default duration is set to 300ms.
         */
        cssHeightAnimated(oldHeight: number, newHeight: number, options: JQuery.EffectsOptions<TElement>): any;
        /**
         ...
         */
        cssWidthToContentAnimated(options: JQuery.EffectsOptions<TElement>): any;
        /**
         ...
         */
        draggable($handle: JQuery, callback?: (position: {
            top: number;
            left: number;
        }) => void): this;
        /**
...
//# sourceMappingURL=jquery-scout-types.d.ts.map